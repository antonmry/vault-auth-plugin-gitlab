...
func (h *CLIHandler) Help() string {
	help := `
Usage: vault login -method=vault-auth-plugin-gitlab [CONFIG K=V...]
  ...
  Authenticate using a GitHub token:
      ...
      $ vault login -method=vault-auth-plugin-gitlab token=abcd1234
...
Configuration:
  ...
  mount=<string>
      ...
      value for -path. The default value is "vault-auth-plugin-gitlab".
